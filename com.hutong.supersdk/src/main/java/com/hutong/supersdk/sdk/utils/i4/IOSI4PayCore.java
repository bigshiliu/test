...
public class IOSI4PayCore {
	 ...
	 * @throws Exception 
     */
    public static Map<String, String> parseSignature(String sign, String pubKey) throws Exception {
		BASE64Decoder base64Decoder = new BASE64Decoder();
        byte[] dcDataStr = base64Decoder.decodeBuffer(sign);
        byte[] plainData = IOSI4RSADecrypt.decryptByPublicKey(dcDataStr, pubKey);
